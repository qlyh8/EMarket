...
//컨슈머 월 추천거래량
public class UsePatternConsumer2Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.use_pattern_item_consumer2, container, false);
        ...
        titleMonth = view.findViewById(R.id.use_pattern_item1_title_month2);
        titlePower = view.findViewById(R.id.use_pattern_item1_title_power_use2);
        baseMoney = view.findViewById(R.id.use_pattern_item1_base_money2);
        powerMoney = view.findViewById(R.id.use_pattern_item1_power_money2);
        basePowerMoney = view.findViewById(R.id.use_pattern_item1_base_power_money2);
        etcMoney1 = view.findViewById(R.id.use_pattern_item1_etc1_money2);
        etcMoney2 = view.findViewById(R.id.use_pattern_item1_etc2_money2);
        totalMoney = view.findViewById(R.id.use_pattern_item1_total_money2);
        saveMoney = view.findViewById(R.id.use_pattern_item1_main_money);
    ...
    private void chartInit(View view){
        ...
        barChart = view.findViewById(R.id.horizontal2);
